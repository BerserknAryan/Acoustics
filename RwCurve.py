...
class AcousticMetrics:
    ...
    def rw(tl):
        ...
        :param tl: Transmission Loss
        """
        return AcousticMetrics.rw_curve(tl)[7]
    ...
    def stc(tl):
        ...
        :param tl: Transmission Loss
        """
        return AcousticMetrics.stc_curve(tl)[6]
...
# tl_data = np.array(...)  # Replace ... with your third-octave data

# rw_value = acoustic_metrics.rw(tl_data)
# rw_c_value = acoustic_metrics.rw_c(tl_data)
#stc_value = acoustic_metrics.stc(tl_data)
# ... and so on
